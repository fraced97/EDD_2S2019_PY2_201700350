            ...
            while (aux_columna != null) {
                ...
                while (aux_Fila != null) {
                    ...
                    if (aux_Fila.getAbajo() != null) {
                        escribir.println("\"" + "Nombre: "+(aux_Fila.getArbol().getNombre()) + " (" + aux_Fila.getX() + ", " + aux_Fila.getY() + ") " +"\n"+(aux_Fila.getArbol().getRuta())+ "\"->\"" + "Nombre: "+(aux_Fila.getAbajo().getArbol().getNombre()) + " (" + aux_Fila.getAbajo().getX() + ", " + aux_Fila.getAbajo().getY() + ") "+"\n"+(aux_Fila.getAbajo().getArbol().getRuta()) + "\"" + "[dir=both];");
                        ...
                        while (true) {
                            while (temp != null) {
                                if (temp.getAbajo() != null) {
                                    escribir.println("\"" + "Nombre: "+(temp.getArbol().getNombre()) + " (" + temp.getX() + ", " + temp.getY() + ") "+"\n"+(temp.getArbol().getRuta()) + "\"->\"" + "Nombre: "+(temp.getAbajo().getArbol().getNombre()) + " (" + temp.getAbajo().getX() + ", " + temp.getAbajo().getY()  + ") " +"\n"+(temp.getAbajo().getArbol().getRuta())+ "\"" + "[dir=both];");
                    ...
                    if (aux_Fila.getSiguiente() != null) {
                        ...
                        if (aux_Fila.getSiguiente() != null) {
                            escribir.println("\"" + "Nombre: "+(aux_Fila.getArbol().getNombre()) + " (" + aux_Fila.getX() + ", " + aux_Fila.getY() + ") " +"\n"+(aux_Fila.getArbol().getRuta())+ "\"->\"" + "Nombre: "+(aux_Fila.getSiguiente().getArbol().getNombre()) + " (" + aux_Fila.getSiguiente().getX() + ", " + aux_Fila.getSiguiente().getY() + ") " +"\n"+(aux_Fila.getSiguiente().getArbol().getRuta())+ "\"" + "[dir=both];");
                        ...
                        while (true) {
                            while (temp != null) {
                                if (temp.getSiguiente() != null) {
                                    escribir.println("rank=same{");
                                    escribir.println("\"" + "Nombre: "+(temp.getArbol().getNombre()) + " (" + temp.getX() + ", " + temp.getY() + ") "+"\n"+(temp.getArbol().getRuta()) + "\"->\"" + "Nombre: "+(temp.getSiguiente().getArbol().getNombre()) + " (" + temp.getSiguiente().getX() + ", " + temp.getSiguiente().getY() + ") "+"\n"+(temp.getSiguiente().getArbol().getRuta()) + "\"" + "[dir=both];");
